<!-- from https://svelte.dev/repl/91649ba3e0ce4122b3b34f3a95a00104?version=3.49.0 -->
...
<script lang="ts">
   ...
   update, so that you can clear it after setting one. */
	...
	export const docStore: Writable<string> = {
		ready: () => view !== null,
		subscribe(cb) {
			subscribers.add(cb);
...
<div {...$$restProps} class="codemirror" bind:this={dom}></div>
